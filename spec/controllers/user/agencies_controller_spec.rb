...
describe User::AgenciesController do
  ...
  describe "GET index" do
    it "assigns all user_agencies as @user_agencies" do
      agency = User::Agency.create! valid_attributes
      get :index, {}, valid_session
      assigns(:user_agencies).should eq([agency])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new agency as @agency" do
      ...
      assigns(:agency).should be_a_new(User::Agency)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved agency as @agency" do
        ...
        User::Agency.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested agency" do
        agency = User::Agency.create! valid_attributes
        # Assuming there are no other user_agencies in the database, this
        # specifies that the User::Agency created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        User::Agency.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the user_agencies list" do
      agency = User::Agency.create! valid_attributes
      delete :destroy, {:id => agency.to_param}, valid_session
      response.should redirect_to(user_agencies_url)
    end
  end
