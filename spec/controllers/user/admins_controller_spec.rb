...
describe User::AdminsController do
  ...
  # User::AdminsController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all user_admins as @user_admins" do
      admin = User::Admin.create! valid_attributes
      get :index, {}, valid_session
      assigns(:user_admins).should eq([admin])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new admin as @admin" do
      ...
      assigns(:admin).should be_a_new(User::Admin)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created admin as @admin" do
        post :create, {:admin => valid_attributes}, valid_session
        assigns(:admin).should be_a(User::Admin)
        assigns(:admin).should be_persisted
      end

      it "redirects to the created admin" do
        post :create, {:admin => valid_attributes}, valid_session
        response.should redirect_to(User::Admin.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin as @admin" do
        ...
        User::Admin.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin" do
        admin = User::Admin.create! valid_attributes
        # Assuming there are no other user_admins in the database, this
        # specifies that the User::Admin created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        User::Admin.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the user_admins list" do
      admin = User::Admin.create! valid_attributes
      delete :destroy, {:id => admin.to_param}, valid_session
      response.should redirect_to(user_admins_url)
    end
  end
