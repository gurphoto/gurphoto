...
describe Hotel::RoomsController do
  ...
  # Hotel::Room. As you add validations to Hotel::Room, be sure to
  ...
  # Hotel::RoomsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET index" do
    it "assigns all hotel_rooms as @hotel_rooms" do
      room = Hotel::Room.create! valid_attributes
      get :index, {}, valid_session
      assigns(:hotel_rooms).should eq([room])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new room as @room" do
      ...
      assigns(:room).should be_a_new(Hotel::Room)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Hotel::Room" do
        expect {
          post :create, {:room => valid_attributes}, valid_session
        }.to change(Hotel::Room, :count).by(1)
      end

      it "assigns a newly created room as @room" do
        post :create, {:room => valid_attributes}, valid_session
        assigns(:room).should be_a(Hotel::Room)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved room as @room" do
        ...
        Hotel::Room.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested room" do
        ...
        # specifies that the Hotel::Room created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Hotel::Room.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
