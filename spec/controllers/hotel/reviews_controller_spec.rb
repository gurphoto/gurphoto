...
describe Hotel::ReviewsController do
  ...
  # Hotel::Review. As you add validations to Hotel::Review, be sure to
  ...
  # Hotel::ReviewsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET index" do
    it "assigns all hotel_reviews as @hotel_reviews" do
      review = Hotel::Review.create! valid_attributes
      get :index, {}, valid_session
      assigns(:hotel_reviews).should eq([review])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new review as @review" do
      ...
      assigns(:review).should be_a_new(Hotel::Review)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Hotel::Review" do
        expect {
          post :create, {:review => valid_attributes}, valid_session
        }.to change(Hotel::Review, :count).by(1)
      end

      it "assigns a newly created review as @review" do
        post :create, {:review => valid_attributes}, valid_session
        assigns(:review).should be_a(Hotel::Review)
        assigns(:review).should be_persisted
      end

      it "redirects to the created review" do
        post :create, {:review => valid_attributes}, valid_session
        response.should redirect_to(Hotel::Review.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved review as @review" do
        ...
        Hotel::Review.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested review" do
        ...
        # specifies that the Hotel::Review created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Hotel::Review.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
